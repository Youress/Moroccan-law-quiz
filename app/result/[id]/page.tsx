...
import ExportAs from "@/components/export-as";
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <Card className="mb-8">
        ...
        <CardContent className="text-center space-y-4">
          <CardDescription>
            تاريخ الاختبار:{" "}
            {new Date(submission.createdAt).toLocaleDateString("ar-MA")}
            {submission.examTag && (
              <span className="mr-4">• امتحان: {submission.examTag}</span>
            )}
          </CardDescription>
          <div className="flex flex-col  space-y-6 md:space-y-8">
            ...
            <ExportAs submissionId={submission.id} />
          </div>
        </CardContent>
      </Card>
      ...
      <div className="space-y-6">
        ...
        {submission.answers.map((userAnswer, index) => {
          ...
          const hasAllCorrect = correctAnswerIds.every((id) =>
            selectedIds.includes(id)
          );
          const hasNoWrong = selectedIds.every((id) =>
